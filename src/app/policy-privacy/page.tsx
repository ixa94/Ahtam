...
export default function PolicyPrivacyPage() {
  return (
    <LegalPage
      ...
      paragraphs={[
        "Настоящая политика определяет порядок обработки персональных данных пользователей сайта банкетного зала АХТАМ.",
        ...
        "Пользователь может отозвать согласие на обработку персональных данных по телефону +7-927-405-31-01."
      ]}
    />
  );
}
